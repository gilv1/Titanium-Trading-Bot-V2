...
MAX_CONSECUTIVE_LOSING_DAYS: int = int(os.getenv("MAX_CONSECUTIVE_LOSING_DAYS", "4"))
LOSING_STREAK_PAUSE_HOURS: int = int(os.getenv("LOSING_STREAK_PAUSE_HOURS", "24"))
...
FUTURES_OPEN_PAUSE_END_HOUR: int = int(os.getenv("FUTURES_OPEN_PAUSE_END_HOUR", "10"))
FUTURES_OPEN_PAUSE_END_MINUTE: int = int(os.getenv("FUTURES_OPEN_PAUSE_END_MINUTE", "15"))
...
BRAIN_WARMUP_MIN_TRADES: int = int(os.getenv("BRAIN_WARMUP_MIN_TRADES", "20"))
BRAIN_WARMUP_SIZE_MULT: float = float(os.getenv("BRAIN_WARMUP_SIZE_MULT", "0.50"))
